...
const OrderPage = () => {
    ...
    const { name = 'Wings Lada Hitam', image = require("../../assets/Ladahitam.jpeg"), price = '3.80' } = route.params || {};
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.addressContainer}>
                ...
                <Text style={styles.address}>Jl. Cisaat Sukabumi</Text>
                <Text style={styles.subAddress}>Rt. 04 Rw. 06 No. 55 Cisaat Cikiray.</Text>
            ...
            <View style={styles.productContainer}>
                ...
                <View>
                    ...
                    <Text style={styles.productDescription}>with Wings</Text>
                </View>
            ...
            <View style={styles.paymentSummary}>
                ...
                <View style={styles.paymentRow}>
                    ...
                    <Text style={styles.paymentTotal}>$5.00</Text>
                </View>
            </View>
